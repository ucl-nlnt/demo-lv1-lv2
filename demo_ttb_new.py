    ...
    def communicator(self):
        ...
        while True:
            ...
            while True:
                ...
                starting_odomtery_data = self.odometry_msg_data_pos
                starting_orientation = quart_funcs.adjust_orientation_origin(normalizing_quat,self.odometry_msg_data)
                print('==============')
                ...
                # [[x, z], dt, max_steps]
                twist, dt, is_done = data

                if is_done: # loop exit condition
                    break
                ...
                distance = compute_distance(self.odometry_msg_data_pos, starting_odomtery_data)
